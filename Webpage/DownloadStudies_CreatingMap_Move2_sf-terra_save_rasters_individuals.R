...
dir.create(paste0(genPath,"WEB_vultureIndv_raster_01"))
pthraster01 <- paste0(genPath,"WEB_vultureIndv_raster_01/")
dir.create(paste0(genPath,"WEB_vultureIndv_raster_nbLocs"))
pthrasterNbLocs <- paste0(genPath,"WEB_vultureIndv_raster_nbLocs/")
