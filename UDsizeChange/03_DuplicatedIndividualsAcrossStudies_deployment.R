...
# path_to_indv_move2 <- "/home/ascharf/Documents/Projects/Drylands/UDsizeChange/2.vultureIndv_mv2_clean_empty_duply//1317318147__NA__3113790894.rds"
...
referenceTableStudies <-  function(path_to_indv_move2){ 
  ...
  if("individual_local_identifier"%in%names(indiv_mv2)){indiv_mv2 <- mt_as_track_attribute(indiv_mv2,individual_local_identifier, .keep=T)}
...
referenceTableStudies_ALL[is.na(referenceTableStudies_ALL$species),c("fileName","MBid")]

## inform owners
# Scavengers DryLands, 3238087490:  BIBEI - 137397 - 2HN & CATALINO - 57797 - no taxa info
# AVulture Namibia SOP, 352166254: cats6 & cats7 - no taxa info

# fileName       MBid
# 903                           1659758323_GriffonSardinia01.rds 1659758323
# 1120 2034212088_G32753 - turquoise black 25 - 3633 - rehab.rds 2034212088
# 1143      2034212088_G36937 - gold black 26 - 3772 - Rehab.rds 2034212088
# 1390                                      2135954755_72869.rds 2135954755
# 1391                                     2135954755_72869b.rds 2135954755
# 1393                                     2135954755_72870b.rds 2135954755
# 1724                       3238087490_BIBEI - 137397 - 2HN.rds 3238087490
# 1728                           3238087490_CATALINO - 57797.rds 3238087490
# 1921                                       352166254_cats6.rds  352166254
# 1922                                       352166254_cats7.rds  352166254

## study: Cape Vulture VulPro South Africa: indiv 143/006/347 has 2 deloy, one in sweden one in sAfrica


referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="1659758323_GriffonSardinia01.rds"] <- "Gyps fulvus"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="2034212088_G32753 - turquoise black 25 - 3633 - rehab.rds"] <- "Gyps coprotheres"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="2034212088_G36937 - gold black 26 - 3772 - Rehab.rds"] <- "Gyps coprotheres"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="2135954755_72869.rds"] <- "Gyps fulvus"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="2135954755_72869b.rds"] <- "Gyps fulvus"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="2135954755_72870b.rds"] <- "Gyps fulvus"
referenceTableStudies_ALL$species[referenceTableStudies_ALL$fileName=="572056515_Gamla 2024 I66 Red.rds"] <- "Neophron percnopterus"
...
lapply(checkL, function(y)try({
  ...
  pl <- ggplot()+geom_sf(data=mt_track_lines(mv2), aes(color=keep))+facet_wrap(~fileName,nrow=1)
  print(pl)
  dev.off()
}))
