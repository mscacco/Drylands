...
outpth <- "/home/ascharf/Documents/Projects/Drylands/UDsizeChange/A1.rastersOfAllSpeciesRange/"
sps <- vulspsNames[1]
...
data1hPth <- "5.vultureIndv_mv2_1h_outlspeed_dist/"
rastPth <- "A1.rastersOfAllSpeciesRange/"
dir.create(paste0(genPath,rastPth))
datrngPth <- "A2.RasterDataOnRange/"
dir.create(paste0(genPath,datrngPth))
...
indvSpsL <- split(indvUsed, as.character(indvUsed$species))
